...
In addition to the default config, this version have a preconfigure NPM, Bower and Gulp.

After download the git, run:
...
Plainkit repository from Github.
    ...
    git clone --recursive https://github.com/julien-gargot/plainkit.git
